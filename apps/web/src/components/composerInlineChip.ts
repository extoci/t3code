...
export const CHAT_INLINE_SKILL_CHIP_CLASS_NAME = `${INLINE_CHIP_GEOMETRY_CLASS_NAME} chat-markdown-skill-chip border border-fuchsia-500/25 bg-fuchsia-500/12 text-[12px] text-fuchsia-700 dark:text-fuchsia-300`;
